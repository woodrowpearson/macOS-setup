...
brew "bench"
# The cat cmd with more features
brew "bat"
...
brew "mtr", link: false
# MacOS command line tool that lets you interact with utilities and applications entirely in Terminal.
brew "m-cli"
...
brew "rustup"
# Display system information in a colorful ascii format and take a screenshot
brew "screenfetch"
...
brew "unrar"
# Up deploys infinite number of serverless http servers and APIs
brew "up"
...
brew "wget"
# CSV cli toolkit written in Rust
brew "xsv"
